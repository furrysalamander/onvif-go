...
func (c *Client) GetConfiguration(ctx context.Context) (*tth.GetConfigurationResponse, error) {
	...
	err := c.c.Do("http://www.onvif.org/ver10/thermal/wsdl/GetConfiguration", &tth.GetConfiguration{}, out)
	return out, err
}
...
func (c *Client) GetConfigurationOptions(ctx context.Context) (*tth.GetConfigurationOptionsResponse, error) {
	...
	err := c.c.Do("http://www.onvif.org/ver10/thermal/wsdl/GetConfigurationOptions", &tth.GetConfigurationOptions{}, out)
	return out, err
}

func (c *Client) GetConfigurations(ctx context.Context) (*tth.GetConfigurationsResponse, error) {
	out := &tth.GetConfigurationsResponse{}
	err := c.c.Do("http://www.onvif.org/ver10/thermal/wsdl/GetConfigurations", &tth.GetConfigurations{}, out)
	return out, err
}
...
func (c *Client) GetRadiometryConfiguration(ctx context.Context) (*tth.GetRadiometryConfigurationResponse, error) {
	...
	err := c.c.Do("http://www.onvif.org/ver10/thermal/wsdl/GetRadiometryConfiguration", &tth.GetRadiometryConfiguration{}, out)
	return out, err
}
...
func (c *Client) GetRadiometryConfigurationOptions(ctx context.Context) (*tth.GetRadiometryConfigurationOptionsResponse, error) {
	...
	err := c.c.Do("http://www.onvif.org/ver10/thermal/wsdl/GetRadiometryConfigurationOptions", &tth.GetRadiometryConfigurationOptions{}, out)
	return out, err
}
...
func (c *Client) GetServiceCapabilities(ctx context.Context) (*tth.GetServiceCapabilitiesResponse, error) {
	...
	err := c.c.Do("http://www.onvif.org/ver10/thermal/wsdl/GetServiceCapabilities", &tth.GetServiceCapabilities{}, out)
	return out, err
}

func (c *Client) SetConfiguration(ctx context.Context) (*tth.SetConfigurationResponse, error) {
	out := &tth.SetConfigurationResponse{}
	err := c.c.Do("http://www.onvif.org/ver10/thermal/wsdl/SetConfiguration", &tth.SetConfiguration{}, out)
	return out, err
}
...
func (c *Client) SetRadiometryConfiguration(ctx context.Context) (*tth.SetRadiometryConfigurationResponse, error) {
	...
	err := c.c.Do("http://www.onvif.org/ver10/thermal/wsdl/SetRadiometryConfiguration", &tth.SetRadiometryConfiguration{}, out)
	return out, err
}
